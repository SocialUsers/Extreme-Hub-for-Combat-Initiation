...
local Window = Rayfield:CreateWindow({
   Name = "Combat Initation (v2.2.0) by Extreme Hub",
   ...
   ConfigurationSaving = {
      ...
      FileName = "Extreme Hub"
   },

   Discord = {
      Enabled = true, -- Prompt the user to join your Discord server if their executor supports it
      Invite = "https://discord.gg/e6wUqPJj7G", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
   ...
   KeySettings = {
      ...
      Subtitle = "Key System",
      Note = "https://discord.gg/e6wUqPJj7G", -- Use this to tell the user how to get a key
      FileName = "Key", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = false, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"thatthatthatISisISkeyskeyskeyslol911"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})
...
Tab:CreateParagraph({Title = "Paintball Gun", Content = "KILL HIM ALL"})
...
Tab4:CreateParagraph({Title = "v2.2.0", Content = "Updated for"})
